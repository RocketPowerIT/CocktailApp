...
class AllCoctail: Codable {
    var drinks:[CurrentCoctailDetail]
  
}

@objcMembers
class MyAllCoctailList: Object, Codable {
    var listKoktail = List<CurrentCoctailDetail>()
}

@objcMembers
class CurrentCoctailDetail:Object, Codable {
    dynamic var idDrink: String
    dynamic var strDrink: String
    dynamic var strDrinkAlternate: String?
    dynamic var strVideo: String?
    dynamic var strCategory: String?
    dynamic var strIBA: String?
    dynamic var strAlcoholic: String?
    dynamic var strGlass: String?
